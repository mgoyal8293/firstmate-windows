...
FM_CREW_STATE_FORGE_TIMEOUT=3   # seconds allowed for the one forge read that confirms a merged or closed PR before fm-crew-state.sh will claim one; budgeted callers narrow it further from what their own budget has left
