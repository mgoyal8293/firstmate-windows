...
FM_PAUSE_RESURFACE_SECS=3600       # seconds before a declared external wait re-surfaces for a recheck; the normal-mode watcher applies it whether its pane sits idle or still renders as busy, the away-mode daemon while idle only
