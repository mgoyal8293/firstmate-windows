...
The margin there is 4 s against 1 s elsewhere, and 4 s is NOT established as sufficient: the measured parent-side cost on the target box is about 2546 ms with nothing else running, and near 10.3 s at the box's own measured contention factor.
