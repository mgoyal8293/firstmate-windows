...
Two items queued against this adapter's liveness reading were settled by the prompt-mark work above, and are recorded here so a reader does not have to infer their state from the mechanism.
